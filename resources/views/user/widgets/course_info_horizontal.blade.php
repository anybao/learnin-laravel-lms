    ...
    <div class="col-lg-6 featured_col">
        <div class="featured_content">
            ...
            <div class="featured_footer d-flex align-items-center justify-content-start">
                <button class="course_button" @if(!$course->isDraft() && $course->chapters->count()>0) onclick="window.location.href='{{ $course->chapters && $course->chapters->first() ? route('courses.lesson.view', [$course, $course->chapters->first()->lessons->first()]) : '#'}}' @endif"><span>Bắt đầu học</span><span class="button_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
